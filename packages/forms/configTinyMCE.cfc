<cfcomponent extends="forms" displayname="TinyMCE Configuration" output="false" 
	...
	<cfproperty 
		...
		fthint="The configuration should be written in the JavaScript notation for TinyMCE outlined at https://www.tiny.cloud/docs-4x/ There is no need to nominate the tinyMCE.init function, just its contents."
