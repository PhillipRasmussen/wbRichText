...
if (e.target.nodeName == 'IMG') {
	...
	function showDialog(imageList) {
		...
		var width, height, imageListCtrl, bulkUploadCtrl, bulkUploadWatch, classListCtrl;
		...
		function buildImageList() {
			...
			tinymce.each(imageList, function(link) {
				linkImageItems.push({
					...
					value: link.value || decodeURIComponent(decodeURI(link.url)),
					menu: link.menu
				});
			});
		...
		function recalcSize(e) {
			...
			console.log('size recalc '+newWidth);
			...
			console.log('size recalc2 '+newWidth);
			width = newWidth;
			height = newHeight;
		}
...
/*
		...
		var generalFormItems = [
			...
			{name: 'style', type: 'textbox',label:'Style',style:'width:300px',text: 'Some nice tooltip to use'},
			classListCtrl
			/*
			{
				type: 'container',
			...
			{name: 'removeSize', type: 'checkbox', checked: false, text: 'Remove Size',onchange: removeSize}*/
		];
